...
use super::tree_sitter::{
    language_dir, normalize_language, register_language_from_dir, register_language_static,
};
...
fn register_builtin_cpp() -> Result<()> {
    ...
    let highlights_query =
        format!("{}{}", tree_sitter_c::HIGHLIGHT_QUERY, include_str!("cpp_highlights_extra.scm"),);
    register_language_static("cpp", tree_sitter_cpp::LANGUAGE.into(), &highlights_query, "", "")
}
