...
void LayoutConfig::widen_watches() { watches_pct = std::min<std::uint16_t>(60, watches_pct + 2); }
void LayoutConfig::narrow_watches() { watches_pct = std::max<std::uint16_t>(20, watches_pct - 2); }
