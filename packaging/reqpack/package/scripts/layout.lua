...
function M.paths(context)
  ...
  local package_root = M.join_path(share_root, "daptor")
  ...
  local package_doc_dir = M.join_path(doc_dir, "daptor")
  local stable_bin_dir = M.join_path(local_root, "bin")
  local binary_path = M.join_path(bin_dir, "daptor")
  local cli_binary_path = M.join_path(bin_dir, "daptor-cli")
  local symlink_path = M.join_path(stable_bin_dir, "daptor")
  local cli_symlink_path = M.join_path(stable_bin_dir, "daptor-cli")
  ...
  return {
    ...
    cli_symlink_path = cli_symlink_path,
  }
end
