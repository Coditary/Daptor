...
local cli_link_ok, cli_link_error = layout.update_symlink(context, paths.cli_binary_path, paths.cli_symlink_path)
if not cli_link_ok then
  context.tx.failed(cli_link_error)
  return false
end
